...
local function on_nth_tick()
	...
	-- TODO: Disabled load balancing as it is not yet configurable
	if false and next(game.connected_players) == nil and game.tick - global.gridworld.load_balancing.inactivity_shutdown_ticks > global.gridworld.load_balancing.last_activity_tick then
